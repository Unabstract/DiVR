...
class DiVRConfig(ArgumentParser):
    def __init__(self):
        super().__init__()
        ...
        self.input_configs.add_argument('--data_freq', default=60, type=int)
        ...
        self.input_configs.add_argument('--disable_graph', default=False, action='store_true')
        self.input_configs.add_argument('--scene_feats_dim', default=256, type=int)
        self.input_configs.add_argument('--graph_feats_dim', default=256, type=int)
        ...
        self.add_argument('--model_type', default='DiVR_het', choices=['DiVR_het', 'DiVR_hom'])
        ...
        self.graph_configs = self.add_argument_group('graph_transformer')
        self.graph_configs.add_argument('--graph_n_heads', default=8, type=int)
        self.graph_configs.add_argument('--graph_hidden_dim', default=256, type=int)
        self.graph_configs.add_argument('--graph_intermediate_dim', default=1024, type=int)
        self.graph_configs.add_argument('--graph_n_layers', default=3, type=int)
        self.graph_configs.add_argument('--graph_latent_dim', default=256, type=int)
        ...
        self.train_configs.add_argument('--slide_win', type=int, default=30)
        self.train_configs.add_argument('--train_set', type=str, default='dataset_40users')
        ...
        self.train_configs.add_argument('--val_fre', type=int, default=1) #3
        ...
        self.eval_configs.add_argument('--batch_size_eval', default=8, type=int)
        self.eval_configs.add_argument('--slide_win_eval', default=30, type=int)
